...
<body>
    <h2 style="position: absolute; top: 10px; left: 400px; font-size: 50px;">TAMPIL PENJUALAN</h2>
</body>
...
<body>
    <nav>
        <ul>
            ...
            <li><a href="tambah_penjualan.php">
                <i class="fas fa-wallet"></i>
                <span class="nav-item">TAMBAH PENJUALAN</span>
            </a></li>
