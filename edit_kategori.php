...
if(isset($_POST['save'])){
    ...
    $Diskon = $_POST['diskon'];
	$update=mysqli_query($koneksi,"UPDATE kategori SET  id_kategori = '$Id_kategori', nama_kategori ='$Nama', diskon ='$Diskon' WHERE kategori.id_kategori='$Id_kategori'");
	if($update){
    ...
    <h1>EDIT KATEGORI</h1>
		...
		<table>
			 <tr>
                ...
                <td><input type="number" name="id_kategori" required value="<?php echo $data['id_kategori'];?>"></td>
            </tr>
            <tr>
                <td>Nama Kategori</td>
